...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_batch_scans_batch_id"), "batch_scans", ["batch_id"], unique=True
    )
    op.create_index(
        op.f("ix_batch_scans_start_time"), "batch_scans", ["start_time"], unique=False
    )
    op.create_table(
        "directory_scans",
        sa.Column("id", sa.String(), nullable=False),
    ...
    op.create_index(
        op.f("ix_directory_scans_directory_path"),
        "directory_scans",
        ["directory_path"],
        unique=False,
    )
    op.create_index(
        op.f("ix_directory_scans_scan_id"), "directory_scans", ["scan_id"], unique=True
    )
    op.create_index(
        op.f("ix_directory_scans_start_time"),
        "directory_scans",
        ["start_time"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_photo_ai_analysis_photo_id"),
        "photo_ai_analysis",
        ["photo_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_photo_metadata_date_taken"),
        "photo_metadata",
        ["date_taken"],
        unique=False,
    )
    op.create_index(
        op.f("ix_photo_metadata_gps_latitude"),
        "photo_metadata",
        ["gps_latitude"],
        unique=False,
    )
    op.create_index(
        op.f("ix_photo_metadata_gps_longitude"),
        "photo_metadata",
        ["gps_longitude"],
        unique=False,
    )
    op.create_index(
        op.f("ix_photo_metadata_photo_id"), "photo_metadata", ["photo_id"], unique=False
    )
    op.create_table(
        "photo_tags",
        sa.Column("id", sa.String(), nullable=False),
    ...
    op.create_index(
        op.f("ix_photo_tags_photo_id"), "photo_tags", ["photo_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["scan_id"], ["directory_scans.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_scan_photo_entries_photo_id"),
        "scan_photo_entries",
        ["photo_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scan_photo_entries_scan_id"),
        "scan_photo_entries",
        ["scan_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_scan_photo_entries_scan_id"), table_name="scan_photo_entries"
    )
    op.drop_index(
        op.f("ix_scan_photo_entries_photo_id"), table_name="scan_photo_entries"
    )
    ...
    op.drop_index(
        op.f("ix_directory_scans_directory_path"), table_name="directory_scans"
    )
