...
class PhotoQueryBuilder:
    ...
    def with_search(self, search_term: str | None) -> "PhotoQueryBuilder":
    ...
    def with_processing_stage(self, stage: str | None) -> "PhotoQueryBuilder":
    ...
    def with_camera_make(self, camera_make: str | None) -> "PhotoQueryBuilder":
    ...
    def with_rating(
        self, rating: int | None = None, rating_min: int | None = None
    ) -> "PhotoQueryBuilder":
    ...
    def with_gps(self, has_gps: bool | None) -> "PhotoQueryBuilder":
    ...
    def with_pagination(
        self, limit: int = 50, offset: int = 0, max_limit: int = 200
    ) -> "PhotoQueryBuilder":
        ...
        self.query = (
            self.query.order_by(Photo.created_at.desc())
            .offset(offset)
            .limit(safe_limit)
        )
        return self
    ...
    async def count(self) -> int:
        ...
        for filter_key in self.applied_filters.keys():
